...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log heap_pq_hw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source heap_pq_hw.tcl -notrace
