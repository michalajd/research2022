...
HD_PWD='C:/Users/ehgartns/Documents/summerReasearch2022/hw_pq_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heap_pq_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heap_pq_hw.tcl
